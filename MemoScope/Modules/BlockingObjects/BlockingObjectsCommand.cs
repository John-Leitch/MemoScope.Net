...
namespace MemoScope.Modules.BlockingObjects
{
    public class BlockingObjectsCommand : AbstractDataUICommand<ClrDump>
    {
        ...
        protected override void HandleData(ClrDump clrDump) => UIModuleFactory.CreateModule<BlockingObjectsModule>(module => { module.UIModuleParent = selectedModule; module.Setup(clrDump); }, module => DockModule(module));
    }
}
