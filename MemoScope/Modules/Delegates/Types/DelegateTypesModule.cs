...
namespace MemoScope.Modules.Delegates.Types
{
    ...
    {
        private List<DelegateTypeInformation> delegateInformations;

        public DelegateTypesModule() => InitializeComponent();
        ...
        public override void Init() => delegateInformations = DelegatesAnalysis.GetDelegateTypeInformations(ClrDump);
