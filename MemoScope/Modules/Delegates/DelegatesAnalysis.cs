...
namespace MemoScope.Modules.Delegates
{
    ...
    public static class DelegatesAnalysis
    {
        ...
        private const string InvocationCountFieldName = "_invocationCount";
        private const string MethodBaseFieldName = "_methodBase";
        private const string MethodPtrFieldName = "_methodPtr";
        private const string MethodPtrAuxFieldName = "_methodPtrAux";
