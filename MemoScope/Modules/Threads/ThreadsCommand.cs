...
namespace MemoScope.Modules.Threads
{
    public class ThreadsCommand : AbstractDataUICommand<ClrDump>
    {
        ...
        protected override void HandleData(ClrDump clrDump) => UIModuleFactory.CreateModule<ThreadsModule>(module => { module.UIModuleParent = selectedModule; module.Setup(clrDump); }, module => DockModule(module));
    }
}
