...
namespace MemoScope.Modules.Process
{
        ...
        IMessageListener<UISettingsChangedMessage>
    {
        ...
        static ProcessModule() => DumpServer = new MemoScopeServer(MemoScopeService.Instance);
        ...
        public ProcessModule()
        {
            ...
            processTriggersControl.LoadTriggers = () =>
            {
                return MemoScopeSettings.Instance != null
                    ? new List<CodeTrigger>(MemoScopeSettings.Instance.ProcessTriggers.Select(t => t.Clone()))
                    : null;
            };
        }
        ...
        private void btnDump_Click(object sender, EventArgs e) => Dump();
        ...
        private static void DumpProcessInfo(string dumpPath, ProcessWrapper proc)
        {
        ...
        private Form GetMainForm()
        {
            ...
            return forms.First(form => form.Handle == handle);
        }
        ...
        public void HandleMessage(UISettingsChangedMessage message) => tbRootDir.Text = MemoScopeSettings.Instance.RootDir;
    }
}