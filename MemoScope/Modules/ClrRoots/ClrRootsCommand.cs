...
namespace MemoScope.Modules.ClrRoots
{
    public class ClrRootsCommand : AbstractDataUICommand<ClrDump>
    {
        ...
        protected override void HandleData(ClrDump clrDump) => UIModuleFactory.CreateModule<ClrRootsModule>(module => { module.UIModuleParent = selectedModule; module.Setup(clrDump); }, module => DockModule(module));
    }
}
